...
import { Check, ChevronDown, ChevronUp } from '@hygraph/icons';
import { cn } from '@/util';
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <Box as={ChevronDown} className="h-4 w-4 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <Box as={ChevronUp} className="h-4 w-4" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <Box as={ChevronDown} className="h-4 w-4" />
  </SelectPrimitive.ScrollDownButton>
));
